...
See [Client-server Communication](/en/guide/api-plugin.html#client-server-communication) for more details, including a section on [Typing Custom Events](/en/guide/api-plugin.html#typescript-for-custom-events).
