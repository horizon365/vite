...
See [Client-server Communication](/ko/guide/api-plugin.html#client-server-communication) for more details, including a section on [Typing Custom Events](/ko/guide/api-plugin.html#typescript-for-custom-events).
