...
See [Client-server Communication](/pt/guide/api-plugin.html#client-server-communication) for more details, including a section on [Typing Custom Events](/pt/guide/api-plugin.html#typescript-for-custom-events).
