...
Today, we're taking another big step in Vite's story. The Vite [team](/de/team), [contributors](https://github.com/vitejs/vite/graphs/contributors), and ecosystem partners are excited to announce the release of Vite 6.
...
If you're new to Vite, we suggest reading the [Getting Started](/de/guide/) and [Features](/de/guide/features) guides first.
...
- [Default value for `resolve.conditions`](/de/guide/migration#default-value-for-resolve-conditions)
- [JSON stringify](/de/guide/migration#json-stringify)
- [Extended support of asset references in HTML elements](/de/guide/migration#extended-support-of-asset-references-in-html-elements)
- [postcss-load-config](/de/guide/migration#postcss-load-config)
- [Sass now uses modern API by default](/de/guide/migration#sass-now-uses-modern-api-by-default)
- [Customize CSS output file name in library mode](/de/guide/migration#customize-css-output-file-name-in-library-mode)
- [And more changes that should only affect a few users](/de/guide/migration#advanced)

There is also a new [Breaking Changes](/de/changes/) page that lists all planned, considering, and past changes in Vite.

## Migrating to Vite 6

For most projects, the update to Vite 6 should be straightforward, but we advise reviewing the [detailed Migration Guide](/de/guide/migration) before upgrading.
