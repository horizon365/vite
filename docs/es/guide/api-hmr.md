...
See [Client-server Communication](/es/guide/api-plugin.html#client-server-communication) for more details, including a section on [Typing Custom Events](/es/guide/api-plugin.html#typescript-for-custom-events).
