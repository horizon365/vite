...
See [Client-server Communication](/ru/guide/api-plugin.html#client-server-communication) for more details, including a section on [Typing Custom Events](/ru/guide/api-plugin.html#typescript-for-custom-events).
