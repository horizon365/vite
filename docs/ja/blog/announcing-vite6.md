...
Today, we're taking another big step in Vite's story. The Vite [team](/ja/team), [contributors](https://github.com/vitejs/vite/graphs/contributors), and ecosystem partners are excited to announce the release of Vite 6.
...
If you're new to Vite, we suggest reading the [Getting Started](/ja/guide/) and [Features](/ja/guide/features) guides first.
...
- [Default value for `resolve.conditions`](/ja/guide/migration#default-value-for-resolve-conditions)
- [JSON stringify](/ja/guide/migration#json-stringify)
- [Extended support of asset references in HTML elements](/ja/guide/migration#extended-support-of-asset-references-in-html-elements)
- [postcss-load-config](/ja/guide/migration#postcss-load-config)
- [Sass now uses modern API by default](/ja/guide/migration#sass-now-uses-modern-api-by-default)
- [Customize CSS output file name in library mode](/ja/guide/migration#customize-css-output-file-name-in-library-mode)
- [And more changes that should only affect a few users](/ja/guide/migration#advanced)

There is also a new [Breaking Changes](/ja/changes/) page that lists all planned, considering, and past changes in Vite.

## Migrating to Vite 6

For most projects, the update to Vite 6 should be straightforward, but we advise reviewing the [detailed Migration Guide](/ja/guide/migration) before upgrading.
